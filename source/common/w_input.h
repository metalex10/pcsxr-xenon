...
#define WPAD_CLASSIC_BUTTON_START PAD_BUTTON_START
#define WPAD_CLASSIC_BUTTON_BACK PAD_BUTTON_BACK
#define WPAD_CLASSIC_BUTTON_LOGO PAD_BUTTON_LOGO
#define WPAD_CLASSIC_BUTTON_RB PAD_BUTTON_RB
#define WPAD_CLASSIC_BUTTON_LB PAD_BUTTON_LB
#define WPAD_CLASSIC_BUTTON_RSTICK PAD_BUTTON_RSTICK
#define WPAD_CLASSIC_BUTTON_LSTICK PAD_BUTTON_LSTICK
